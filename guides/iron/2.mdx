...
The program you executed in the last chapter is known as the famous ‘Hello World’ program. This is, by tradition, the first program every beginner writes. Let’s take a look at what each line actually does.
...
For the time being, I will ignore the first line. The second line is empty. The compiler ignores empty lines and so you can add as many or as little as you want. However, programmers often leave a line between significant code blocks in order to make the code look more tidy as shown in this example.
...
<Exercise number='1' question={`How could you change the following code such that it outputs the text, 'Hello C++!'
\`\`\`
#include <iostream>
int main()
{
