...
```
int someNumber = 0;
someNumber = returningFunction();       //returningFunction is executed and someNumber is set to the return value of returningFunction (i.e. 10)
```
...
bool isEven(int number){
    ...
    return false;   //This code will not be executed if the above if statment was executed (since then, the previous return statement would have been executed)
