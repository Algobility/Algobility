...
However, practically, competitive programmers know to not name their variables something like `cout`. It also becomes quite tedious to write `std::` before each occurance of `cout` or `cin`. Therefore, most competitive programmers simply add the following line at the top of their code
