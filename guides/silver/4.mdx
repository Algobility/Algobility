...
# Finding pairs
Brute force is an invaluable technique that can be used to solve most bronze level problems. It involves searching all possible answers for the correct one. Consider the following problem
...
for (int i = 0; i < n; i++){
  for (int j = 0; j < n; j++){
    //for every iteration here, the values of i and j will be every possible 2-number permutation of 0...n
  }
}
```
...
- <a href='https://cses.fi/book/book.pdf#page=57'>https://cses.fi/book/book.pdf#page=57</a>